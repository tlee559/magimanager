...
import { userRepository, type UserFindOptions, type UserWithRelations } from "@/lib/repositories";
...
class UserService {
  async getById(id: string): Promise<UserServiceResult<UserWithRelations>> {
    try {
  ...
  async getByEmail(email: string): Promise<UserServiceResult<UserWithRelations>> {
    try {
  ...
  async getAll(options: UserFindOptions = {}): Promise<UserServiceResult<UserWithRelations[]>> {
    try {
  ...
  async create(data: UserCreateInput): Promise<UserServiceResult<UserWithRelations>> {
    try {
  ...
  async update(id: string, data: UserUpdateInput): Promise<UserServiceResult<UserWithRelations>> {
    try {
  ...
  async resetPassword(id: string): Promise<UserServiceResult<{ temporaryPassword: string }>> {
    try {
      const existing = await userRepository.findById(id);
      if (!existing) {
        return { success: false, error: "User not found" };
  ...
  async setRole(id: string, role: UserRole): Promise<UserServiceResult<UserWithRelations>> {
    try {
      const existing = await userRepository.findById(id);
      if (!existing) {
        return { success: false, error: "User not found" };
  ...
  async deactivate(id: string): Promise<UserServiceResult<UserWithRelations>> {
    try {
      const existing = await userRepository.findById(id);
      if (!existing) {
        return { success: false, error: "User not found" };
  ...
  async activate(id: string): Promise<UserServiceResult<UserWithRelations>> {
    try {
      const existing = await userRepository.findById(id);
      if (!existing) {
        return { success: false, error: "User not found" };
